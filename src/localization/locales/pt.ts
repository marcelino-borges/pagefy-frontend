...
export const pt: IDictionary = {
  ...
  ok: "OK",
  recurrency: {
    titleSingular: "Recorrência",
    titlePlural: "Recorrências",
    monthly: "Mensal",
    month: "Mês",
    yearly: "Anual",
    year: "Ano",
  ...
  tools: {
    button: {
      ...
      typeTextOnly: "Botão contendo apenas um texto.",
      typeTextAndImage: "Botão contendo texto e imagem.",
      typeImageOnly: "Botão contendo apenas uma imagem.",
      typeTextOverImage: "Botão contendo um texto sobre uma imagem.",
      columnsHelpText:
  ...
  vipPlan: {
    name: "Vip",
    benefits: ["Crie até 5 páginas", "Utilize animações em seus componentes"],
  },
  platinumPlan: {
    name: "Platinum",
    benefits: [
      "Suporte especial e prioritário",
      "Crie quantas páginas quiser",
      "Aplique animações em seus componentes",
      "Agende quando seu componente ficará visível publicamente",
      "Analise como sua página está performando através de nossos analytics (cliques, carregamentos da página etc.)",
      "Insire seu próprio código Javascript personalizado em sua página",
    ],
  },
  benefits: "Benefícios",
  currency: "R$",
  ...
  createNowYourPage: "Faça agora sua página!",
  ...
  testimonials: {
    ...
    zeroRatingDialogText:
      "Deseja realmente avaliar o Pagefy com a nota 0 ou esqueceu de selecionar uma nota?",
  ...
  customScripts: {
    ...
    customScriptDescription:
      "Use esses campos se você for um usuário avançado, para rodar código Javascript personalizado na sua página.",
  ...
  home2: {
    ...
    iconTextCards: [
      ...
      },
      {
        ...
        subtitle:
          "Deixe sua página com a sua cara, edite cores, imagens e componentes",
      },
      {
