...
export const en: IDictionary = {
  ...
  generalErrors: {
    ...
    signUpNotAllowed: "Pagefy isn't available to the public yet.",
    unexpectedError: "Sorry, we had an unexpected error.",
  },
  subscribeErrors: {
    fetchPlan: "Error finding plan details",
    signInToSubscribe: "Sign in to subscribe",
    activeSubscriptionFoundCancel:
      "You have an active subscription. Access your profile and cancel it before purchasing another subscription",
  },
  profile: "Profile",
  ...
  vipPlan: {
    name: "Vip",
    benefits: ["Create until 5 page", "Use animations in your components"],
  },
  platinumPlan: {
    name: "Platinum",
    benefits: [
      "Special and prioritized support",
      "Create as many page as you want",
      "Apply animations to your components",
      "Schedule when a component gets publicly visible",
      "Analyse how your page is performing using our analytics (clicks, loadings etc.)",
  ...
  testimonials: {
    ...
    zeroRatingDialogText:
      "Do you really want to rate Pagefy with 0 or have you forgotten to select your rating?",
  ...
  customScripts: {
    ...
    customScriptDescription:
      "Use these fields if you're an advanced user, to run custom Javascript code in your page.",
  ...
  home2: {
    ...
    iconTextCards: [
      ...
      },
      {
        ...
        subtitle:
          "Create your page with your style, set colors, images and components",
      },
      {
