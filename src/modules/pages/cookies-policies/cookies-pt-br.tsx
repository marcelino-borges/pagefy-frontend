const CookiesPoliciesPTBR = () => (
  <>
    ...
    <p>
      ...
      Política de Cookies, cada vez que qualquer um destes termos é mencionado,
      são estritamente definidos como:
    </p>
    <ul>
      <li>
        Cookie: pequena quantidade de dados gerada por um site e salva pelo seu
        navegador da web. É usado para identificar seu navegador, fornecer
        análises, lembrar informações sobre você, como sua preferência de idioma
      ...
      <li>
        ...
        concursos, parceiros promocionais e de marketing, e outros que fornecem
    ...
    <p>
      ...
      fornecer análises, lembrar informações sobre você, como sua preferência de
      idioma ou informações de login. Eles são completamente seguros e não podem
      ser usados para executar programas ou enviar vírus para seu dispositivo.
    </p>

    <h1>Por que usamos cookies?</h1>
    <p>
      Usamos cookies de primeira e/ou terceira parte em nosso site para diversos
      fins, tais como:
    </p>
    <ul>
      ...
      <li>
        Permitir-nos criar uma experiência de usuário personalizada para você e
        entender o que é útil ou de interesse para você;
      </li>
      <li>
        Analisar como nosso site é usado e como podemos personalizá-lo da melhor
        forma;
      </li>
      <li>
        Identificar futuros prospectos e personalizar interações de marketing e
        vendas com eles;
      </li>
    ...
    <p>
      ...
      cookie persistente permanecerá até expirar ou até você excluir seus
      cookies. As datas de expiração são definidas nos próprios cookies; alguns
      podem expirar após alguns minutos, enquanto outros podem expirar após
      vários anos. Os cookies colocados pelo site que você está visitando são
      chamados de "cookies de primeira parte".
    </p>
    <p>
    ...
    <p>
      Esses cookies são usados para aprimorar o desempenho e a funcionalidade de
      nosso site, mas não são essenciais para seu uso. No entanto, sem esses
      cookies, determinadas funcionalidades, como vídeos, podem se tornar
      indisponíveis ou você precisará inserir seus detalhes de login toda vez
      que visitar o site, pois não seríamos capazes de lembrar que você fez
      login anteriormente.
    </p>
    ...
    <p>
      ...
      campanhas de marketing, ou para nos ajudar a personalizar nosso site para
      você.
    </p>
    <p>
      Utilizamos cookies servidos pelo Google Analytics para coletar dados
      limitados diretamente dos navegadores de usuários finais, a fim de melhor
      compreender o uso de nosso site por você. Mais informações sobre como o
      Google coleta e usa esses dados podem ser encontradas em:
      https://www.google.com/policies/privacy/partners/. Você pode optar por não
      participar de todas as análises suportadas pelo Google em nossos Sites,
      visitando: https://tools.google.com/dlpage/gaoptout.
    </p>
    ...
    <p>
      ...
      criar públicos-alvo direcionados para anúncios futuros e fazer remarketing
      para usuários qualificados que já tomaram determinadas ações na
      plataforma.
    </p>
    ...
    <p>
      ...
      funcionalidade, publicidade, marketing e análise descritos acima. Não
      controlamos o uso desses cookies de terceiros, pois os cookies só podem
      ser acessados pelo terceiro que os definiu originalmente.
    </p>
    <h1>Como você pode gerenciar cookies?</h1>
    <p>
      A maioria dos navegadores permite que você controle os cookies por meio de
      suas preferências de 'configurações'. No entanto, se você limitar a
    ...
    <p>
      Onde quer que você esteja localizado, também pode configurar seu navegador
      para bloquear cookies e tecnologias semelhantes, mas essa ação pode
      bloquear nossos cookies essenciais e impedir que nosso site funcione
      corretamente, e você pode não conseguir aproveitar totalmente todas as
      suas funcionalidades e serviços. Você também deve estar ciente de que pode
      perder algumas informações salvas (por exemplo, detalhes de login salvos,
      preferências do site) se bloquear cookies em seu navegador. Navegadores
      diferentes oferecem controles diferentes. Desativar um cookie ou categoria
      de cookie não exclui o cookie do seu navegador, você precisará fazer isso
      manualmente em seu navegador; consulte o menu de ajuda do seu navegador
    ...
    <p>
      ...
      Serviço e políticas. A menos que seja exigido por lei, notificaremos você
      (por exemplo, por meio de nosso Serviço) antes de fazer alterações nesta
      Política de Cookies e daremos a você a oportunidade de revisá-las antes
      que entrem em vigor. Em seguida, se você continuar a usar o Serviço,
      ficará vinculado à Política de Cookies atualizada. Se você não concordar
      com esta ou qualquer Política de Cookies atualizada, pode excluir sua
      conta.
    </p>

    <h1>Seu Consentimento</h1>
    <p>
      Ao usar nosso site, registrar uma conta ou fazer uma compra, você consente
      com nossa Política de Cookies e concorda com seus termos.
    </p>
    <h1>Entre em Contato Conosco</h1>
    <p>
      Não hesite em nos contatar se tiver alguma dúvida sobre nossa Política de
      Cookies.
    </p>
    <ul>
