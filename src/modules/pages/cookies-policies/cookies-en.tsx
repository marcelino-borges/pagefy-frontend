...
const CookiesPoliciesEN = () => {
  ...
  useEffect(() => {
    logAnalyticsEvent(ANALYTICS_EVENTS.pageView, {
      ...
      page_title: "Cookies Policies EN",
  ...
  return (
    <>
      ...
      <p>
        ...
        "Pagefy", "we", "us", and "ours"), use cookies and similar technologies
        to recognize you when you visit our website, including without
        limitation https://pagefy.me and any related URLs, mobile or localized
...
export default CookiesPoliciesEN;
