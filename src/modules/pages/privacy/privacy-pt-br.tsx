const PrivacyPTBR = () => (
  <>
    ...
    <p>
      ...
      Política de Privacidade toda vez que um desses termos for utilizado, serão
      estritamente como definido abaixo:
      <ul>
        <li>
        ...
        <li>
          <strong>Endereço IP</strong>: A cada dispositivo conectado à Internet
          é atribuído um número conhecido como endereço de protocolo de Internet
          (IP). Esses números são geralmente atribuídos em blocos geográficos.
          Um endereço IP pode frequentemente usado para identificar o local de
        ...
        <li>
          ...
          fornecerem nosso conteúdo, cujo produtos ou serviços podem interessar
          você.
        </li>
        <li>
    ...
    <p>
      ...
      our site, place an order, subscribe to our newsletter, respond to a survey
      or fill out a form.
    </p>
    ...
    <p>
      ...
      orders for products and services you may purchase through the website. We
    ...
    <p>
      ...
      we, in our sole discretion, believe necessary or appropriate in order to
      ...
      actionable activity, or to otherwise comply with applicable court orders,
    ...
    <p>
      ...
      its conflict of laws provision. You consent to the exclusive jurisdiction
    ...
    <p>
      ...
      using our website, registering an account, or making a purchase, you
    ...
    <ul>
      <li>
        ...
        <p>
          ...
          synching with location, plan routes, or create a mashup just to name a
          few.
        </p>
        <p>
