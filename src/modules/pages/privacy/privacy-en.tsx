  ...
  return (
    <>
      ...
      <p>
        ...
        Pagefy. By accessing or using our Service, you signify that you have
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            ...
            it refers to pagefy.me, Belfield Crescent, Farranshone, Limerick,
          ...
          <li>
            ...
            up to use the Pagefy Service to manage the relationships with your
            consumers or service users.
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Pagefy and
            use the services.
          </li>
          <li>
          ...
          <li>
            Service: refers to the service provided by Pagefy as described in
