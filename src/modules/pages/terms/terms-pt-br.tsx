const TermsOfUsePTBR = () => (
  <>
    ...
    <ul>
      <li>
        Cookie: pequena quantidade de dados gerados por um site e salva pelo seu
    ...
    <p>
      ...
      possamos avaliar e processar o reembolso, se aplicável.
    </p>
    <p>
      Não oferecemos reembolsos ou trocas por produtos que você afirma ter
      recebido em boas condições, mas que estão fora do período de garantia de 7
      dias após a compra.
    </p>
    <p>
    ...
    <p>
      Se aprovado, o reembolso será processado e um crédito será automaticamente
      aplicado ao seu método original de pagamento, dentro de um determinado
      número de dias.
    </p>
    <p>
    ...
    <p>
      O uso continuado do nosso site será considerado como aceitação das nossas
    ...
    <p>
      ...
      fornecer pelo menos 30 dias de antecedência antes que novos termos entrem
      em vigor. O que constitui uma alteração material será determinado a nosso
      critério.
    </p>
    <p>
